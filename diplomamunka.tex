...
\begin{itemize}
    \item Mi a favicon? Touch icon is van
    \item Célok:
        \begin{itemize}
            \item Authentikációs hiba kijavítása a Qt WebEngine-ben
                \begin{itemize}
                    \item Megoldás: ikonok letöltése a Chromium Content API-n keresztül
                \end{itemize}
            \item Legjobb minőségű ikon propagálása
                \begin{itemize}
