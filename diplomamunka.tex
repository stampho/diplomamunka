...
Felvezető duma \dots
\begin{itemize}
    \item erőforrás igény, memória, de azért megy embedded-en
    \item cross-platform
    \item biztosan van gyorsabb, kisebb
    ...
    \item kódnév: \textbf{diplomabrowser}
    \item próbáltam a 2. fejezetben leírt funkcionalitásokat bemutatni
\end{itemize}
