...
megjeleníteni. Továbbá, bizonyos \texttt{RenderObject}-hez saját \texttt{RenderLayer}-t is
...
\newpar
Ahogy az \ref{figure-rendering-trees} ábrán is látszik \dots
\begin{itemize}
    \item Melyik fa, mi?
    \item Chrome (Chromium?) Compositor
    \item RenderLayerBacking
    \item GraphicsLayer
    \item WebLayer
    \item RenderObject paints to WebLayer Buffer
    \item TextureLayer
    \item TextureMailbox
\end{itemize}
