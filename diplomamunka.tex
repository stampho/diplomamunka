...
az első Favicon Manager patch jelentős részét teszi ki.
...
\begin{itemize}
    \item Javítás: ne küldjük ki az \texttt{iconChanged} signal-t ha az \texttt{iconUrl}
        nem is változott
\end{itemize}
...
\begin{itemize}
    \item Azoknak az internal API függvényeknek az eltávolítása, amelyek egy publikus
        Favicon Manager API-hoz lettek volna szükségesek:
        \begin{itemize}
            \item \texttt{downloadIcon()}
            \item \texttt{removeIcon()}
        \end{itemize}
    \item Régi működés megtartása, hogy az első favicon-t propagáljuk => felesleges
    \item A kiválasztott ikon tárolása a \texttt{NavigationEntry}-ben
