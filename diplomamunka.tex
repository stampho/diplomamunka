...
\begin{itemize}
    ...
    \item \texttt{ENABLE\_QML\_TESTSUPPPORT\_API} makró
    \item Build rendszer megpiszkálása: csak akkor buildelődjön ha tesztek is engedélyezve
        vannak
    \item error page tesztek hozzáadása
    \item új QML típus
    \item ütközés elkerülése az experimental API-val
    \item warning ha valaki testsupport API-te letiltva tesztel
\end{itemize}
\pagebreak
