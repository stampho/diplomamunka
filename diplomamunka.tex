...
nem lecserélhetőek a Chromium-ban. Ilyen például a network library.

A web elemek kirajzolását viszont a Qt végzi. A mailbox texture id-k segítségével a
QtWebEngine hozzáfér a Chrome Compositor által összeállított textúrákhoz, amelyek a
megosztott OpenGL context-en vannak tárolva. Ezeket a textúrákat pedig a Qt Quick Scene
Graph fogja kirajzolni. Emiatt, a Chromium-ban a GPU process ki van kapcsolva, mert a GPU-t
a Qt használja, ami a Browser process-ben fut.
...
A QtWebEngine Process a Chromium Render Process-ét valósítja meg. \dots
\begin{itemize}
    \item Hogyan indul?
    \item Miért felel?
        \begin{itemize}
