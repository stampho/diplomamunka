...
\begin{comment}
Ahhoz, hogy a felhasználó a QtWebEngine-t beépítő alkalmazás indításakor felüldefiniálhassa
a Qt beállításait is, a \texttt{-{}-lang} parancssori kapcsoló ellenőrzését hozzáadtam
Browser Processhez is:
\newpage
\begin{lstlisting}[title=src/core/web\_engine\_library\_info.cpp]
 std::string WebEngineLibraryInfo::getApplicationLocale()
 {
    ...
    return parsedCommandLine->GetSwitchValueASCII(
                                        switches::kLang);
 }
\end{lstlisting}
\end{comment}
