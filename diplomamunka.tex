...
\noindent
A QtWebEngine modul bővítése úgy, hogy a QtWebKit modult használó fejlesztők \\
könnyen portolhassák a projektjüket QtWebEngine-re.
...
\begin{itemize}
    ...
    \item \textbf{A megadott feladat megfogalmazása:} \\
        A QtWebEngine modul bővítése új funkciókkal és azok tesztelése a
...
Google után. A kérdés adott volt: megtartsa e a Qt jól bevált QtWebKit modulját és maradjon
az Apple szárnysegédje, vagy beálljon az új lehetőségeket és irányt mutató Google mögé
azáltal, hogy az ő web platformjára épít egy új modult. Végül az utóbbi mellett döntöttek,
a QtWebKit projektet parkolópályára helyezték és a QtWebEngine éles lett.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{qt_repos_and_modules}
    \caption{
...
Természetesen a modulok között függőségek is vannak. \dots

\begin{itemize}
    \item qtcore-tól minden függ -> qtbase minden projekt/komponens függősége
    \item függőségek hol/hogyan vannak definiálva?
