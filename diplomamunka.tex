...
\begin{itemize}
    ...
    \item Callback függvény hogyan nez ki? -> didFindText(requestId, matchCount)
    \item activeMatchOrdinal: Chromium bug miatt nem került bele (a callback paraméterbe)
    \item activeMatchOrdinal a widget API-ban sem volt benne
    \item activeMatchOrdinal: hanyadik találat?
    \item quicktestbrowser: Ctrl+F
    \item Qt 5.4: experimental API
    \item Qt 5.5: mainline API, nincs változás, csak mozgatva és dokumentálva
\end{itemize}
