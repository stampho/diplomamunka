...
\begin{itemize}
    \item Implementáció a Core modulban: Favicon Manager
    \item \texttt{WebContents::DownloadImage} Content API függvény használata az ikon
        letöltésére
    \item Összes ikon letöltése és a legjobb minőségű ikon kiválasztása/propagálása
    \item Ikon betöltés QRC-ből (Qt Resource System)
    \item Ikon cache-elése
    \item Egyszerűség kedvéért: minden tabhoz (webContents) egy Favicon Manager
    \item Új QML és Widget favicon tesztek
    \item C++11 for loop-ok használata
\end{itemize}
