...
Ez az API a Chromium-hoz enged hozzáférést és jellemzően a Widget és Quick API-kkal kell
...
A Qt WebEngine Widget modul \texttt{C++} osztályokat nyújt widget GUI létrehozására. Az API
...
\begin{itemize}
    \item navigation history: látogatott oldalak listája
    \item profile: weboldalak közös beállításokkal (offTheRecord -> privát mód)
